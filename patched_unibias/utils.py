...
def prepare_dataset_test(dataset_name, content_free_inputs=None, demonstration=None, num_shot=1):
    '''gen testing prompts: selecting different examples for different random seeds'''
    if dataset_name == 'sst2':
        prompt_list = []
        dataset_test = load_dataset("sst2", split="validation", trust_remote_code=True)
        ...
        if content_free_inputs:
            ...
            examples = load_dataset("sst2", split="train", trust_remote_code=True)
    ...
    if dataset_name == 'sst5':
        prompt_list = []
        dataset_test = load_dataset("SetFit/sst5", split="test", trust_remote_code=True)
        ...
        if content_free_inputs:
            ...
            # generate demonstration
            examples = load_dataset("SetFit/sst5", split="train", trust_remote_code=True)
    ...
    if dataset_name == 'trec':
        ...
        if content_free_inputs:
            ...
            # generate demonstration
            examples = load_dataset(dataset_name, split="train", trust_remote_code=True)
            examples_samples = examples['text']
    ...
    if dataset_name == 'ag_news':
        prompt_list = []
        dataset_test = load_dataset(dataset_name, split="test", trust_remote_code=True)[:3000]
    ...
    if dataset_name in ('cr', 'mr'):
        prompt_list = []
        if dataset_name == 'cr':
            dataset_test = load_dataset("SetFit/CR", split="test", trust_remote_code=True)
            examples = load_dataset("SetFit/CR", split="train", trust_remote_code=True)
        elif dataset_name == 'mr':
            dataset_test = load_dataset("mattymchen/mr", split="test", trust_remote_code=True)[:3000]
            examples = load_dataset("mattymchen/mr", split="test", trust_remote_code=True)[3000:]
        test_samples = dataset_test['text']
        test_labels = dataset_test['label']
        test_sentences = test_samples
        if content_free_inputs:
    ...
    if dataset_name == 'copa':
        prompt_list = []
        dataset_test = load_dataset("super_glue", dataset_name, split="validation", trust_remote_code=True)
        test_premise = dataset_test['premise']
        ...
        if content_free_inputs:
            ...
            # generate demonstration examples
            examples = load_dataset("super_glue", dataset_name, split="train", trust_remote_code=True)
            examples_premise = examples['premise']
    ...
    if dataset_name == 'arc':
        prompt_list = []
        dataset_test = load_dataset('ai2_arc', 'ARC-Challenge', split="test", trust_remote_code=True)
        ...
        if content_free_inputs:
            ...
            # generate demonstration examples
            examples = load_dataset('ai2_arc', 'ARC-Challenge', split="train", trust_remote_code=True)
    ...
    if dataset_name == 'mmlu':
        prompt_list = []
        dataset_test = load_dataset("cais/mmlu", 'all', split="test", trust_remote_code=True).shuffle()[:2000]
        test_question = dataset_test['question']
        test_choices = dataset_test['choices']
        ...
        if content_free_inputs:
            ...
            # generate demonstration examples
            examples = load_dataset("cais/mmlu", 'all', split="validation", trust_remote_code=True)
            examples_question = examples['question']
            examples_choices = examples['choices']
...
def prepare_dataset_validate(dataset_name, demonstration=None):
    '''Generate support set for grid search'''
    if dataset_name == 'sst2':
        prompt_list = []
        dataset_validate = load_dataset("sst2", split="train", trust_remote_code=True)
    ...
    if dataset_name == 'sst5':
        prompt_list = []
        dataset_validate = load_dataset("SetFit/sst5", split="train", trust_remote_code=True)
    ...
    if dataset_name == 'mnli':
        prompt_list = []
        dataset_validate = load_dataset("nyu-mll/glue", dataset_name, split="train", trust_remote_code=True)
    ...
    if dataset_name == 'ag_news':
        prompt_list = []
        dataset_validate = load_dataset(dataset_name, split="train", trust_remote_code=True)
    ...
    if dataset_name in ('cr', 'mr'):
        prompt_list = []
        if dataset_name == 'cr':
            dataset_validate = load_dataset("SetFit/CR", split="train", trust_remote_code=True)
        elif dataset_name == 'mr':
    ...
    if dataset_name == 'copa':
        prompt_list = []
        dataset_validate = load_dataset("super_glue", dataset_name, split="train", trust_remote_code=True)
        valid_premise = dataset_validate['premise']
    ...
    if dataset_name == 'arc':
        prompt_list = []
        dataset_validate = load_dataset('ai2_arc', 'ARC-Challenge', split="train", trust_remote_code=True)
    ...
    if dataset_name == 'mmlu':
        prompt_list = []
        dataset_validate = load_dataset("cais/mmlu", 'all', split="validation", trust_remote_code=True)
        valid_question = dataset_validate['question']
        valid_choices = dataset_validate['choices']
