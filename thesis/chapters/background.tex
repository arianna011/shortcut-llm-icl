...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{assets/Shortcut Types.png}
    \caption{Classification of LLM shortcuts in the In-Context Learning (ICL) paradigm}
    \label{fig:types}
\end{figure}
...
% detection -> performance degradation and explainability analysis
